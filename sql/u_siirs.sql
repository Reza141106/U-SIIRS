...
DROP TABLE IF EXIST status_updates;
DROP TABLE IF EXIST report_attachments;
...
CREATE TABLE reports_attachments (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE status_updates (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_su_report FOREIGN KEY (report_id) REFERENCES report(id) ON DELETE CASCADE,
...
CREATE TABLE notifications (
    ...
    CONSTRAINT fk_notif_report FOREIGN KEY (report_id) REFERENCES report(id) ON DELETE SET NULL
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXIST contact_messages (
    id INT AUTO_INCREMENT PRIMARY KEY,
